...
$portalName = config('branding.primary.portal_name', 'Digi Federation');
...
return [
    ...
    'diving_log_validation_request' => [
        'subject' => 'Pedido de Validação de Registo de Mergulho',
        'line_intro' => 'Foi feito um pedido para validar um dos seus registos de mergulho.',
        'line_diver' => 'Mergulhador: :name',
        'line_date' => 'Data: :date',
        'line_location' => 'Local: :location',
        'action' => 'Ver Pedido de Validação',
        'line_outro' => 'Obrigado por utilizar a nossa aplicação!',
        'database_title' => 'Pedido de Validação de Registo de Mergulho',
        'database_message' => 'Foi feito um pedido para validar um dos seus registos de mergulho.',
        'database_short' => 'Existe um novo registo de mergulho para validar.',
    ],

    'diving_log_validated' => [
        'database' => 'Um novo registo de mergulho foi validado.',
    ],
];
