...
return [
    ...
    'no_international_license_access_description' => 'Não está associado a uma federação que tenha acordos de licenças internacionais. Apenas membros de federações com acordos internacionais CMAS podem adquirir estas licenças.',
    ...
    // CMAS and codes
    'CMAS International Code' => 'Código Internacional CMAS',
    ...
    'CMAS Scientific Entity Licenses' => "Licencas Entidade {$internationalName}",
    'CMAS Scientific Professional Licenses' => "Licencas Profissional {$internationalName}",
    ...
    'Purchase a CMAS license for your entity' => "Compre uma licenca {$internationalShortName} para a sua entidade",
    'Purchase International Professional Licenses' => "Adquirir Licencas Profissional {$internationalName}",
    'Select members and purchase CMAS licenses on their behalf' => "Selecione membros e adquira licencas {$internationalShortName} em seu nome",
    'Purchase CMAS Scientific Entity License' => 'Adquirir Licença Entidade CMAS Científico',
    'Purchase a CMAS scientific license for your entity' => 'Compre uma licença CMAS científica para a sua entidade',
    'Purchase CMAS Scientific Professional Licenses' => 'Adquirir Licenças Profissional CMAS Científico',
    'Select members and purchase CMAS scientific licenses on their behalf' => 'Selecione membros e adquira licenças CMAS científicas em seu nome',
    ...
    'federation_cmas_diving_entity_licenses_subtitle' => 'Licenças CMAS atribuídas a centros de mergulho',
    'federation_cmas_diving_individual_licenses_title' => "Licencas de Profissionais {$internationalName}",
    'federation_cmas_diving_individual_licenses_subtitle' => 'Licenças CMAS atribuídas a profissionais de mergulho',
    ...
    'admin_cmas_diving_entity_licenses_title' => 'Licenças de Entidades CMAS',
    'admin_cmas_diving_entity_licenses_subtitle' => 'Todas as licenças CMAS atribuídas a entidades',
    'admin_cmas_diving_individual_licenses_title' => 'Licenças de Profissionais de Mergulho Recreativo CMAS',
    'admin_cmas_diving_individual_licenses_subtitle' => 'Todas as licenças atribuídas a profissionais de mergulho recreativo CMAS',
    'admin_scientific_entity_licenses_title' => 'Licenças de Entidades CMAS Científico',
    'admin_scientific_entity_licenses_subtitle' => 'Todas as licenças científicas atribuídas a entidades CMAS',
    ...
    'cmas_international_licenses' => 'Licenças Internacionais CMAS',
    'international_licenses_description' => 'As suas licenças internacionais reconhecidas pela CMAS em todo o mundo',
