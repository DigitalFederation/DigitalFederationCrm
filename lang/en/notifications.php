...
return [
    ...
    'diving_log_validation_request' => [
        'subject' => 'Request for Diving Log Validation',
        'line_intro' => 'A request has been made to validate one of your diving logs.',
        'line_diver' => 'Diver: :name',
        'line_date' => 'Date: :date',
        'line_location' => 'Location: :location',
        'action' => 'View Validation Request',
        'line_outro' => 'Thank you for using our application!',
        'database_title' => 'Request for Diving Log Validation',
        'database_message' => 'A request has been made to validate one of your diving logs.',
        'database_short' => 'There is a new diving log to validate.',
    ],

    'diving_log_validated' => [
        'database' => 'A new diving log was validated.',
    ],
];
