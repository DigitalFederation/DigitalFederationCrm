...
enum EvtEventOrganizationCategoryEnum: string
{
    ...
    case cmas_commission_meeting = 'cmas_commission_meeting';
    case cmas_general_assembly = 'cmas_general_assembly';
    case cmas_other = 'cmas_other';
    ...
    public static function getGroupedOptions(): array
    {
        return [
            ...
            config('branding.international.name', 'International Federation') => [
                self::cmas_commission_meeting->name,
                self::cmas_general_assembly->name,
                self::cmas_other->name,
            ],
        ];
    }
    ...
    public static function toString($event_category): string
    {
        ...
        return match ($eventCategory) {
            ...
            // International federation
            self::cmas_commission_meeting => __('event_applications.event_categories.cmas_commission_meeting'),
            self::cmas_general_assembly => __('event_applications.event_categories.cmas_general_assembly'),
            self::cmas_other => __('event_applications.event_categories.cmas_other'),
