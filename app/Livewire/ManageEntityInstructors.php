...
class ManageEntityInstructors extends Component implements HasForms, HasTable
{
        ...
        return $table
            ->query(
                Individual::query()
                    ...
                    // Note: We bypass ExcludeInternationalScope to include international licenses (e.g., CMAS instructor licenses)
            ...
            ->actions([
                Action::make('invite')
                    ->label(__('cmas_diving.invite'))
                    ->icon('heroicon-o-user-plus')
                    ->color('primary')
                    ->modalHeading(__('cmas_diving.invite_instructor_or_leader'))
                    ->modalDescription(__('cmas_diving.invite_confirmation_message'))
                    ->modalSubmitActionLabel(__('cmas_diving.send_invitation'))
                    ...
                    ->action(function (Individual $record): void {
                        ...
                        try {
                            ...
                            $invitation = EntityProfessionalRoleInvitation::create([
                                ...
                                'status' => 'pending',
                                'message' => __('cmas_diving.you_have_been_invited'),
    ...
    public function removeAssociation(int|string $entityProfessionalRoleId): void
    {
        try {
            ...
            $cmasCode = $entityProfessionalRole->individual?->code_cmas ?? 'N/A'; // Store for logging
            ...
            activity()
                ...
                ->log("Instructor/Leader relationship removed: {$cmasCode}");
