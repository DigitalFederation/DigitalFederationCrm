...
class UploadOfficialDocument extends Component
{
    ...
    public function getAvailableTypesProperty()
    {
        ...
        $types->push(OfficialDocumentTypeEnum::CmasAthleteCodeOfConduct);
        $types->push(OfficialDocumentTypeEnum::CmasCoachCodeOfConduct);
        $types->push(OfficialDocumentTypeEnum::CmasRefereeJudgeCodeOfConduct);
