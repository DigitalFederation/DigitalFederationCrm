...
class EventTechnicalDelegateForm extends Component
{
    ...
    public string $codeCmasDelegateFederation = '';
    ...
    protected function rules()
    {
        return [
            ...
            'codeCmasDelegateFederation' => 'required|string|exists:individual,code_cmas',
    ...
    protected function messages()
    {
        return [
            ...
            'codeCmasDelegateFederation.required' => 'Please enter a valid CMAS code.',
            'codeCmasDelegateFederation.exists' => 'The CMAS code must exist in our records.',
    ...
    private function initializeDelegate(Competition $competition)
    {
        ...
        if (! empty($delegate)) {
            ...
            $this->codeCmasDelegateFederation = $delegate->code_cmas_delegate_federation;
    ...
    private function fetchOrAssignIndividualId()
    {
        if (empty($this->individualId)) {
            $this->individualId = Individual::where('code_cmas', $this->codeCmasDelegateFederation)->firstOrFail()->id;
        }
    }
    ...
    public function save()
    {
        ...
        $delegateData = [
            ...
            'code_cmas_delegate_federation' => $this->codeCmasDelegateFederation,
