...
class IndividualSelectorModal extends Component implements HasForms, HasTable
{
    ...
    protected function getTableQuery(): Builder
    {
        ...
        // If $federationId is null and user is not a federation user (i.e., CMAS user),
    ...
    protected function getTableColumns(): array
    {
        return [
            ...
            Tables\Columns\TextColumn::make('code_cmas')->searchable(),
    ...
    {
        $this->isOpen = false;
        $this->dispatch('individual-selected', code: $individual->code_cmas, inputId: $this->inputId);
    }
