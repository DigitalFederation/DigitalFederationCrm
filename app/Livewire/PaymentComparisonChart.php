...
class PaymentComparisonChart extends ChartWidget
{
    ...
    protected function getData(): array
    {
        ...
        foreach ($paymentsData as $payment) {
            ...
            $labels[] = $federation ? $federation->code_cmas : 'Unknown Federation';
            $data[] = $payment->total_payments;
            $backgroundColors[] = '#' . substr(md5($federation ? $federation->code_cmas : 'unknown'), 0, 6); // Color based on federation name
        }
