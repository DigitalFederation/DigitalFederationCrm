 ...
 * populate the input field with their CMAS code.
 *
 * Usage:
 * <div class="relative">
 ...
 *
 *
 * @property string $inputId The ID of the input field to be populated with the selected individual's CMAS code
 ...
 * @example
 * // In a Blade view:
 * <x-individual-selector input-id="student_cmas_code" :federation-id="$currentFederationId" />
 */
class FederationIndividualSelector extends Component
{
    ...
    public function __construct($inputId, $federationId = null, $wireModel = null)
    {
        ...
        if ($federationId !== null) {
            ...
            $this->federationId = null; // This will allow CMAS users to select from all individuals
        }
    }
