...
class Layout extends Component
{
    ...
    protected function determineAllowedActions()
    {
        ...
        $this->allowedActions = [
            ...
            'validateCertification' => $isPendingCertification && ($isFederation || $isCmas) && ! empty($certification->national_code) && (! $isLocalFederation || $isCmas),
            'rejectCertification' => $isPendingCertification && ($isFederation || $isCmas),
            'editCertification' => $isPendingCertification && ($isFederation || $isCmas) && (! $isLocalFederation || $isCmas),
            'suspendCertification' => $isActiveCertification && ($isFederation || $isCmas),
            'activateCertification' => $canUnsuspend && ($isFederation || $isCmas),
        ];
    }
