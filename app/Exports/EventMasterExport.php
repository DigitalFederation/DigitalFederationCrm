...
class EventMasterExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    public function map($event): array
    {
        return [
            ...
            $event->organizer->organizable?->code_cmas ?? 'N/A',
            ...
            $event->competition?->technicalDelegates->pluck('code_cmas_delegate_federation')->implode(', ') ?? 'N/A',
    ...
    public function headings(): array
    {
        return [
            ...
            'Nº Silver', 'Nº Bronze', 'Technical Delegate Name', 'Technical Delegate CMAS Code',
