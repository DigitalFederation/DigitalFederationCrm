...
use Domain\EvtEvents\States\RefereeEnrollment\ActiveRefereeEnrollmentState;
...
class RefereeEnrollmentController extends Controller
{
    ...
    {
        // CMAS users don't need to pass a federation - this will be handled by the Livewire component
