...
class DocumentController extends Controller
{
    ...
    public function invoices(Request $request): View
    {
        ...
        $request->validate([
            ...
            'filter_cmas_code' => 'nullable|string',
        ]);
            ...
            'owner' => function ($query) {
                $query->when(
                    ...
                    ->when(
                        ...
                        fn ($q) => $q->with([
                            'entityFederations:id,name,code_cmas',
                            'country:id,name',
                        ])
                    )
                    ->when(
        ...
        $queryBuilder = QueryBuilder::for(Document::class)
            ...
            ->with([
                ...
                'owner' => function ($morphTo) {
                    $morphTo->morphWith([
                        \Domain\Entities\Models\Entity::class => ['federations:id,name,code_cmas,country_id', 'country:id,name'],
                        \Domain\Individuals\Models\Individual::class => ['federations:id,name,code_cmas'],
