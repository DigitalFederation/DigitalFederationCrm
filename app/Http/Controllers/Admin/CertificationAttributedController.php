...
class CertificationAttributedController extends BaseCertificationAttributedController
{
    ...
    public function index(): View
    {
        $certifications_attributed = QueryBuilder::for(CertificationAttributed::class)
            ->allowedFilters([
                ...
                AllowedFilter::scope('filter_individual_cmas_code', 'filterIndividualCmasCode'),
        ...
        $certifications = Certification::select('id', 'name')
            ...
            ->orderBy('name')
            ->get();
        $federations = Federation::select('id', 'name', 'code_cmas')->orderBy('name')->get();
     ...
     * Permissions: CMAS, FEDERATION, INDIVIDUAL
     */
