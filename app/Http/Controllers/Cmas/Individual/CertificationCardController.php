...
/**
 * CMAS Individual Certification Card Controller
 *
...
class CertificationCardController extends Controller
{
    public function index(): View
    {
        ...
        return view('web.cmas.individual.certification-card.index', compact(
    ...
    public function show(string $id): View|RedirectResponse
    {
        ...
        return view('web.cmas.individual.certification-card.show', compact('certificationAttributed'));
    }
    ...
    public function download(CertificationAttributed $certificationAttributed): BinaryFileResponse
    {
        ...
        try {
            ...
            return redirect()->back()
                ->with('error', __('cmas.error.card_generation_failed'));
        }
    }
}
