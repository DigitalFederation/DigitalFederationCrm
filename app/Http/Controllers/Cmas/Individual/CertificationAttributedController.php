...
/**
 * CMAS Individual Certification Attributed Controller
 *
...
class CertificationAttributedController extends Controller
{
    public function index(): View
    {
        ...
        return view('web.cmas.individual.certifications.index', compact(
            'certifications',
            'countries',
            'professional_roles',
            'filter_status'
    ...
    public function show(string $id): View
    {
        ...
        return view('web.cmas.individual.certifications.show', compact('certification'));
    }
}
