...
namespace App\Http\Controllers\Cmas\Federation;
...
/**
 * CMAS Federation Certification Attributed Controller
 *
...
class CertificationAttributedController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('web.cmas.federation.certifications-attributed.index', compact(
    ...
    public function show(string $id): View|RedirectResponse
    {
        ...
        $certification_attributed = Cache::remember("cmas_certification_attributed_{$id}", 60, function () use ($id, $childFederationIds) {
            return CertificationAttributed::select(
                ...
                ->with([
                    ...
                    'individual:id,name,surname,code_cmas,qrcode_path',
                    'individual.media',
                    'entity',
                    'activator:id,name',
                    'mainInstructor',
                    'federation:id,code_cmas,country_id,name',
        ...
        if (empty($certification_attributed)) {
            return redirect()->back()->with('error', __('cmas.error.certification_not_found'));
        }
        ...
        return view('web.cmas.federation.certifications-attributed.show', [
