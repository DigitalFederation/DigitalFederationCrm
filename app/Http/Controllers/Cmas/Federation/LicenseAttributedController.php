...
/**
 * CMAS Federation License Attributed Controller
 *
...
class LicenseAttributedController extends Controller
{
    ...
    public function index(): View
    {
        ...
        if ($committee) {
            ...
            if ($professional) {
                $title .= ' ' . $professionalLabel . ' ' . __('cmas.licenses');
            } else {
                $title .= ' ' . ucwords($holderType) . ' ' . __('cmas.licenses');
            }
        } else {
            $title = ucwords($holderType) . ' ' . __('cmas.licenses');
        }

        return view('web.cmas.federation.licenses-attributed.index', compact(
            'licenses',
            'sports',
            'filter_status',
            'professional_roles',
    ...
    public function show(string $id): View|RedirectResponse
    {
        ...
        return view('web.cmas.federation.licenses-attributed.show', compact('license'));
    }
}
