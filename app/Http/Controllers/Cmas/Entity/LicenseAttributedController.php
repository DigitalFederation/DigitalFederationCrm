...
/**
 * CMAS Entity License Attributed Controller
 *
...
class LicenseAttributedController extends BaseLicenseAttributedController
{
    ...
    public function index(): View
    {
        ...
        return view('web.cmas.entity.licenses-attributed.index', compact(
            'licenses',
            'committee',
            'filter_status',
            'sports',
    ...
    public function show(string $id): View|RedirectResponse
    {
        ...
        return view('web.cmas.entity.licenses-attributed.show', compact('license'));
    }
    ...
    public function individuals(): View
    {
        ...
        if (! $user->hasRole(['entity-admin', 'entity-operator'])) {
            abort(403, __('cmas.error.no_permission_member_licenses'));
        }
        ...
        return view('web.cmas.entity.member-licenses.index', compact('licenses', 'entity'));
    }
}
