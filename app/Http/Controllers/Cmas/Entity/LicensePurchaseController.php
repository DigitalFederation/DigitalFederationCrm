...
namespace App\Http\Controllers\Cmas\Entity;
...
/**
 * CMAS Entity License Purchase Controller
 *
...
class LicensePurchaseController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        if (! $entity) {
            abort(403, __('cmas.error.no_entity_profile'));
        }
        ...
        return view('web.cmas.entity.license-purchase.index', [
            'entity' => $entity,
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if (! $license) {
            ...
            return back()->withErrors(['license_id' => __('cmas.error.license_not_found')])->withInput();
        }
        ...
        try {
            ...
            if ($request->license_type === 'entity') {
                ...
                return redirect()
                    ->route('cmas.entity.license-purchase.success')
                ...
                if (! $licenses || $licenses->isEmpty()) {
                    throw new \Exception(__('cmas.error.no_licenses_created'));
                }
                ...
                return redirect()
                    ->route('cmas.entity.license-purchase.success')
                    ->with('success', __('cmas.success.member_licenses_purchased', ['count' => $licenses->count()]))
    ...
    public function success(): View|RedirectResponse
    {
        ...
        if (! $licenseAttributedId && ! $licenseCount) {
            return redirect()->route('cmas.entity.license-purchase.index')
        ...
        return view('web.cmas.entity.license-purchase.success', compact(
            'licenseAttributed',
            'licenseCount',
            'purchaseType',
            'license',
