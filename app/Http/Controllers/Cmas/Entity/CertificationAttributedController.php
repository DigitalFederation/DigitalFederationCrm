...
/**
 * CMAS Entity Certification Attributed Controller
 *
...
class CertificationAttributedController extends Controller
{
    public function index(): View
    {
        ...
        return view('web.cmas.entity.certifications.index', compact(
            'certifications',
            'countries',
            'professional_roles',
            'filter_status',
    ...
    public function show(string $id): View
    {
        ...
        return view('web.cmas.entity.certifications.show', compact('certification', 'entity'));
    }
}
