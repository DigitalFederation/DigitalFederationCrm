...
class AthleteController extends Controller
{
    public function index(): View
    {
        ...
        $pendingInvitations = EntityProfessionalRoleInvitation::where('entity_id', $entity->id)
            ...
            ->with('individual:id,name,surname,code_cmas')
        ...
        try {
            ...
            activity()
                ...
                ->withProperties([
                    ...
                    'cmas_code' => $entityAthlete->individual?->code_cmas,
                ])
                ->log(__('athletes.activity_athlete_removed', ['code_cmas' => $entityAthlete->individual?->code_cmas]));
