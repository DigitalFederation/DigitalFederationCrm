...
class LicensePurchaseController extends Controller
{
    ...
    public function sportEntity()
    {
        return $this->renderPurchasePage(
            ...
            false,
            __('licenses.Purchase Sport Club License'),
            __('licenses.Purchase a sport license for your club')
        );
    }
    ...
    public function divingCmasEntity()
    {
        return $this->renderPurchasePage(
            ...
            true,
            __('licenses.Purchase International Entity License'),
            __('licenses.Purchase a CMAS license for your entity')
        );
    }

    /**
     * Scientific entity license purchase (Mergulho Científico CMAS)
     */
    public function scientificEntity()
    {
        return $this->renderPurchasePage(
            'entity',
            CommitteeCodeEnum::Scientific->value,
            true,
            __('licenses.Purchase CMAS Scientific Entity License'),
            __('licenses.Purchase a CMAS scientific license for your entity')
        );
    }

    /**
     * Sport member license purchase
     */
    public function sportMembers()
    {
        return $this->renderPurchasePage(
            'members',
            CommitteeCodeEnum::Sport->value,
            false,
            __('licenses.Purchase Sport Licenses'),
            __('licenses.Select members and purchase sport licenses on their behalf')
        );
    }
    ...
    public function divingCmasMembers()
    {
        return $this->renderPurchasePage(
            ...
            CommitteeCodeEnum::Diving->value,
            true,
            __('licenses.Purchase International Professional Licenses'),
            __('licenses.Select members and purchase CMAS licenses on their behalf')
        );
    }

    /**
     * Scientific member license purchase
     */
    public function scientificMembers()
    {
        return $this->renderPurchasePage(
            'members',
            CommitteeCodeEnum::Scientific->value,
            true,
            __('licenses.Purchase CMAS Scientific Professional Licenses'),
            __('licenses.Select members and purchase CMAS scientific licenses on their behalf')
        );
    }

    /**
     * Primary federation diving service member license purchase.
     * National diving licenses for members
     */
    public function nationalDivingMembers()
    {
        return $this->renderPurchasePage(
            'members',
            CommitteeCodeEnum::DivingServices->value,
            false,
            __('licenses.Purchase Primary Diving Services Licenses'),
            __('licenses.Select members and purchase primary diving licenses on their behalf')
        );
    }

    /**
     * Render license purchase page with fixed committee and international parameters
     */
    ...
    public function store(Request $request)
    {
        ...
        // Apply the same filters as in the Livewire component
        // Normalize committee to uppercase for comparison
        $committeeUpper = $committee ? strtoupper($committee) : null;
        if ($committeeUpper === CommitteeCodeEnum::Sport->value || $committeeUpper === CommitteeCodeEnum::DivingServices->value) {
            // Sport and DIVINGSERVICES committees - only national licenses
        ...
        } elseif ($committeeUpper && ! in_array($committeeUpper, [CommitteeCodeEnum::Sport->value, CommitteeCodeEnum::DivingServices->value], true)) {
            // Other committees (like DIVING, SCIENTIFIC) - only international licenses
