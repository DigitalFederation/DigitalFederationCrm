...
class EventStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        // Add conditional rules for competition events
        if ($this->input('event_category') === 'competition') {
            $rules += [
                ...
                'technical_delegate.code_cmas_delegate_federation' => 'required_with:technical_delegate.name|nullable|string',
                ...
                'competition.required_coach_certifications.*' => 'exists:license,id',
                'competition.required_referee_certifications' => 'nullable|array',
                'competition.required_referee_certifications.*' => 'exists:license,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'technical_delegate.code_cmas_delegate_federation.required' => 'The CMAS delegate code is required.',
            'technical_delegate.code_cmas_delegate_federation.required_with' => 'The CMAS delegate code is required when the technical delegate name is provided.',
            'technical_delegate.code_cmas_delegate_federation.exists' => 'The CMAS delegate code must exist in the records.',
