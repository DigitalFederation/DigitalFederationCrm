...
class CmasDivingCertificationsListReport implements ReportTemplate
{
    public static function getDisplayName(): string
    {
        return __('reports.cmas_diving_certifications_list');
    }
    ...
    public function query($filters)
    {
        $query = CertificationAttributed::query()
            ...
            ->whereHas('certification.committee', fn ($q) => $q->where('code', 'DIVING'));
