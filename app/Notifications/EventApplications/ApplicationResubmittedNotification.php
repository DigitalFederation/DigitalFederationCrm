...
class ApplicationResubmittedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('event_applications.notifications.admin.resubmitted.subject'))
            ->markdown('emails.event-applications.application-resubmitted', [
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'message' => __('event_applications.notifications.admin.resubmitted.message'),
            'url' => $this->getAdminUrl(),
        ];
    }
    ...
    {
        return route('cmas.event-applications.show', $this->application->id);
    }
}
