...
class DivingCertificationRequirementService
{
    ...
    /**
     * Check if individual has valid CMAS certifications for the license.
     * This maintains compatibility with existing CMAS certification checking.
     */
    public function individualHasValidCMAScertifications(Individual $individual, License $license): bool
    {
        // Check if individual has active CMAS certifications
