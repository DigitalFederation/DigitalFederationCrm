...
class RoleAndPermissionSeeder extends Seeder
{
    public function run()
    {
        ...
        Permission::firstOrCreate(['name' => 'access diving location']);
        Permission::firstOrCreate(['name' => 'access diving log']);
        ...
        $association_cmas_admin = Role::firstOrCreate(['name' => 'association-cmas-admin']);
        ...
        $entity_cmas = Role::firstOrCreate(['name' => 'entity-cmas']);
        ...
        $association_cmas_admin->syncPermissions([
            'access federations',
            'access products',
            'access entities',
            'access individuals',
        ...
        // Assign permissions for Entity CMAS (formerly entity_company)
        $entity_cmas->syncPermissions([
            'access orders',
        ]);
