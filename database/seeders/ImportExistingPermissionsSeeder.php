...
class ImportExistingPermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        $commonPermissions = [
            ...
            // Diving
            ['name' => 'access-diving-location', 'description' => 'View diving locations', 'category' => 'Diving'],
            ['name' => 'manage-diving-locations', 'description' => 'Create and manage diving locations', 'category' => 'Diving'],
        ];
