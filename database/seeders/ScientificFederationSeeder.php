...
class ScientificFederationSeeder extends Seeder
{
    /**
     * Federação com membership ativa do plano com committee scientific
    ...
    public function run(): void
    {
        ...
        $plan = MembershipPlan::factory()->create([
            'committee_id' => Committee::where('code', 'SCIENTIFIC')->first()->id,
        ]);
