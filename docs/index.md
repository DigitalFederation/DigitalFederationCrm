...
1. **Committee Structure** - See [Committee Structure](/architecture/02-committee-structure)
   - `SPORT`, `DIVINGSERVICES` = National (is_international = false)
   - `DIVING`, `SCIENTIFIC` = International/CMAS (is_international = true)
...
| Document | Description |
|----------|-------------|
| [Federation Membership Rules](/access-control/federation-membership-rules) | **CRITICAL** - Local vs Modalidade federation rules |
