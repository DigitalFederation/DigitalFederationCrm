...
2. **Activate it**
   ...
   - The system will automatically:
     ...
     - Assign the REFEREE professional role to the person
...
1. **Check the person's profile**
   ...
   - You should see a Referee role listed (e.g., "Arbitro de Hockey Subaquatico")
...
| Has REFEREE professional role? | Individual profile > Professional Roles | Activation should auto-assign |
| Already enrolled? | Event > Review enrollments | Already in the event |
...
│     └── CMAS creates certification linked to REFEREE role       │
│                          │                                      │
│                          ▼                                      │
...
│     └── Status: ACTIVE                                          │
│     └── System auto-assigns REFEREE professional role           │
│                          │                                      │
│                          ▼                                      │
...
### Referees
```php
// Requires REFEREE professional role
$query->whereHas('professionalRoles', fn($q) => $q->where('role', 'REFEREE'))
