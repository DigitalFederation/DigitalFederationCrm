# 02_payment_system.md

This document describes the extensible payment gateway architecture and the specific integration with EasyPay.
...
('EasyPay', 'easypay', 'Domain\Payments\Handlers\EasyPayPaymentHandler', 1, 'Pagamento seguro via EasyPay...');
```
