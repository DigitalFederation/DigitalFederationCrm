...
> **Note**: For comprehensive EasyPay documentation including authorization/capture flows,
> see `/docs/easypay_integration.md`
...
The system includes a comprehensive admin interface for payment management accessible at `/admin/payment-methods`.
...
The webhook monitoring uses a dedicated `webhook_logs` table:
