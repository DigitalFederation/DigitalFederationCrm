...
|-------------|------------------|---------|
| **Technical Delegate Report** | Technical Delegate (Delegado Tecnico) | Overall event assessment and incident documentation |
| **Chief Technical Official Report** | Chief Judge (Oficial Tecnico Chefe) | Referee presence tracking and function assignments |
...
The Technical Delegate submits a comprehensive report covering all aspects of the competition.
...
The Chief Judge (Oficial Tecnico Chefe) manages referee tracking and submits a technical considerations report.
...
Referee functions are defined per sport/modality in the `evt_referee_functions` table.

**Example Functions (Sports Diving - Mergulho Desportivo):**
- Secretariado (Secretary)
- Partidas (Starts)
- Auxiliar Pre-Partidas (Pre-Start Assistant)
