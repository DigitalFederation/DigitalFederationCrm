...
class CertificationAttributedData
{
    public function __construct(
        ...
        public ?string $cmas_international_code,
    ...
    public static function fromArray(CertificationAttributedRequest|array $data): self
    {
        ...
        return new self(
            ...
            $data['cmas_international_code'] ?? null,
    ...
    public function toArray(): array
    {
        return [
            ...
            'cmas_international_code' => $this->cmas_international_code,
    ...
    public function toModel(): CertificationAttributed
    {
        ...
        $model->cmas_international_code = $this->cmas_international_code;
