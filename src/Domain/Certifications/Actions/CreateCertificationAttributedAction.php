...
class CreateCertificationAttributedAction
{
     ...
     *
     * This action is utilized by entities such as CMAS, federations, or instructors
    ...
    public function __invoke(
        ...
        foreach ($certificationAttributedData->individual_ids as $individualId) {
            ...
            if (! $checkIndividualHasCertification($individualId, $certificationId)) {
                ...
                $individualCertData['cmas_international_code'] = UtilityMethods::generateCertificationCmasInternationalNumber(date('Y'), $federation->id);
