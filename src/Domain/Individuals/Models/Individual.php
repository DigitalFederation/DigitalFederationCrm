...
class Individual extends Model implements HasMedia
{
    ...
    protected $fillable = ['country_id', 'district_id', 'user_id', 'name', 'surname', 'first_name_latin', 'last_name_latin', 'native_name', 'birthdate', 'gender', 'email', 'address', 'location', 'postal_code', 'doc_ref_type', 'doc_ref', 'doc_ref_validation_date', 'vat_number', 'phone', 'created_by', 'updated_by', 'code_cmas', 'member_number', 'national_federation_number', 'qrcode_path', 'facebook_url', 'x_url', 'instagram_url', 'linkedin_url', 'has_cmas_portal', 'visible_in_coach_registry', 'visible_in_technical_official_registry', 'visible_in_diving_professional_registry'];
    ...
    {
        return $this->hasMany(DivingBuddy::class);
    }
    ...
    public function sequenceLog(): HasOne
    {
        return $this->hasOne(IndividualSequenceLog::class);
    }
    ...
    {
        return $this->full_name ?? $this->code_cmas;
    }
     ...
     */
    public function scopeFilterCmasCode(Builder $query, string $code): Builder
    {
        return $query->where('code_cmas', 'like', '%' . $code . '%');
    }
