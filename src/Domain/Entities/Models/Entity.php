...
class Entity extends Model implements HasMedia
{
    ...
    public function divingCourses(): HasMany
    {
        return $this->hasMany(DivingCourse::class);
    }
    public function divingLocations(): MorphMany
    {
        return $this->morphMany(DivingLocation::class, 'owner');
    }
    ...
    public function featuredDivingLocations(): BelongsToMany
    {
        return $this->belongsToMany(DivingLocation::class, 'entity_featured_diving_location', 'entity_id', 'diving_location_id');
    }
}
