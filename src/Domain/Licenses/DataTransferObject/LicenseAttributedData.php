...
class LicenseAttributedData
{
    public function __construct(
        ...
        public ?string $owner_cmas_code = null,
        ...
        if ($this->federation_id) {
            ...
            if ($fed) {
                ...
                $this->federation_code = $fed->code_cmas;
            }
        }
    ...
    public function toArray(): array
    {
        return [
            ...
            'owner_cmas_code' => $this->owner_cmas_code,
    ...
    public static function fromArray(array $attributes): self
    {
        return new self(
            ...
            owner_cmas_code: $attributes['owner_cmas_code'] ?? null,
