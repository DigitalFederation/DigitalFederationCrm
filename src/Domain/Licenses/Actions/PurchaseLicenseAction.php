...
class PurchaseLicenseAction
{
    ...
    public function __invoke(License $license, $purchaser, array $additionalData = []): LicenseAttributed
    {
        ...
        // DIVING (international CMAS) can have multiple licenses of the same type
        ...
        try {
            ...
            // Include both DIVING (international CMAS) and DIVINGSERVICES (non-international diving services)
            ...
            if ($isDivingLicense && $requiresValidation && $isEntity && ! $isInternational) {
                ...
                // International licenses (CMAS DIVING, CMAS SCIENTIFIC) skip admin validation entirely
