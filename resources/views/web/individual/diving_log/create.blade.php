<x-layout>
  <div class="px-2 py-4 sm:px-6 lg:px-8 w-full">
        ...
        <div class="max-w-4xl">
          ...
          <div class="flex items-center gap-x-4 mb-4">
            ...
            <div>
              ...
              <p class="text-blue-100 text-sm md:text-base mt-1">Record #{{ $nextDiveNumber ?? '001' }}</p>
            </div>
          </div>
    ...
    <div class="sm:w-2/3 lg:w-full">
      <livewire:diving-log-form :individual="Auth()->user()->individuals()->first()"></livewire:diving-log-form>
    </div>
  </div>
</x-layout>
