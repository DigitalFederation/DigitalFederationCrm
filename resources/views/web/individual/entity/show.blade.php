    ...
    <div class="previous-layout-classes">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 mt-1">
                            ...
                            @if($entity->code_cmas)
                                ...
                                <span class="text-sm font-mono text-slate-500 dark:text-slate-400">{{ $entity->code_cmas }}</span>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                <a href="{{ route('individual.entity.index') }}" class="btn btn-secondary">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm p-6">
                ...
                <dl class="space-y-4">
                    ...
                    @if($entity->code_cmas)
                        <div>
                            <dt class="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">{{ __('main.CMAS Code') }}</dt>
                            <dd class="mt-1">
        ...
        @if($entity->federations && $entity->federations->count() > 0)
            <div class="mt-6 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700">
                    <h3 class="text-sm font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wide flex items-center gap-2">
                        <svg class="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                            @foreach($entity->federations as $federation)
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium bg-emerald-100 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-300">
