<x-layout>
    ...
    @php
        ...
        $isCmasContext = isset($context) && $context === 'cmas';
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <x-individual.profile-tabbed 
                ...
                :context="$context"
                :showUserAccount="$isCmasContext"
                :showProfessionalRoles="$isCmasContext || $isFederationContext"
                :showDocuments="($isCmasContext || $isFederationContext) && isset($official_documents)"
