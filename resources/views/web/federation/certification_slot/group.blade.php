        ...
        <div class="sm:flex sm:justify-between sm:items-center">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="page-first-title">{{ date('d/m/Y', strtotime($firstSlot->created_at)) }}
                    :: {{ $federation?->code_cmas . __(' Slot Order ') }} </h1>
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-6 mt-16 ">
            ...
            <div class="card col-span-full xl:col-span-6 flex flex-col flex-auto">
                ...
                @if(!empty($federation))
                    <div class="flex flex-col flex-auto mt-2">
                        ...
                        <div class="mb-2">
                            <div class="text-secondary font-semibold">{{ __('certifications.cmas_code')}}</div>
                            <p class="text-slate-500">{{ $federation?->code_cmas }}</p>
                        </div>
                        <div class="mb-2">
            ...
            <div class="col-span-full xl:col-span-6 flex flex-col flex-auto">
                ...
                <div class="card gap-4 justify-around overflow-hidden">
                    ...
                    @if($firstSlot->shipping_address)
                        <div class="flex flex-col md:flex-row justify-between mt-2">
                            <div>
                                <div class="text-secondary font-semibold">{{ __('certifications.shipping_address')}}</div>
                                <p class="text-slate-500">
                                    {{ $firstSlot->shipping_address }},
                                    {{ $firstSlot->shipping_postal_code }} {{ $firstSlot->shipping_location }}
                                    ,
                                    {{ $firstSlot->shipping_country_zone }}
                                    | {{ $firstSlot->shipping_country }}
                                </p>
                            </div>
                        </div>
                    @endif
