<x-guest-layout>
    <div
        ...
        <div class="my-8 text-center">
            <h1 class="text-2xl md:text-3xl text-slate-600 font-bold"> {{ __('Activate Your :app Account', ['app' => config('branding.primary.portal_name', config('app.name', 'Digi Federation'))]) }} </h1>
