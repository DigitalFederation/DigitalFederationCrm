    ...
    <div class="previous-layout-classes">
        ...
        <div class="sm:flex sm:justify-center sm:items-center mb-5">
            @if(!empty($individuals) && $individuals->count() > 0)
                <x-dynamic-table
                    :headers="[__('main.name'), __('main.Nationality'), __('main.CMAS Code'), __('main.birthdate'), __('members.requested_date'), ['text'=>__('main.status'),'alignment'=>'right'], '']">
                    @foreach($individuals as $individual)
                        ...
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">{{ $individual->code_cmas }}</td>
