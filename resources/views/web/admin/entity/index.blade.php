    ...
    <div class="previous-layout-classes">
        ...
        <div class="sm:flex flex-row gap-4">
            ...
            <x-filter-form :post="route('admin.entity.index')">
                ...
                <x-forms.filter-input-text label="{{ __('entity.id_number') }}" name="filter_cmas_code"/>
                ...
                <x-forms.filter-input-select label="{{ __('individuals.cmas_portal') }}" name="has_cmas_portal" :options="$cmasPortalOptions" />
            </x-filter-form>
            ...
            <x-dynamic-table
                ...
                @foreach($entities as $entity)
                    ...
                    <tr>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">{{ $entity->code_cmas ?? '-' }}</td>
