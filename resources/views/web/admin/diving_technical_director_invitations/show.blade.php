                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="mt-1">
                                ...
                                <span class="text-sm text-gray-500">{{ $invitation->entity->code_cmas ?? $invitation->entity->id }}</span>
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-1">
                                ...
                                <span class="text-sm text-gray-500">{{ $invitation->individual->code_cmas }}</span>
                            </p>
                        </div>
