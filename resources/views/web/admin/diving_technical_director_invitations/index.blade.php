                            ...
                            <tr class="border-t">
                                <td class="px-4 py-3">
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-500">{{ $invitation->entity->code_cmas ?? $invitation->entity->id }}</div>
                                    </div>
                                </td>
                                <td class="px-4 py-3">
                                    <div>
                                        <div class="font-medium">{{ $invitation->individual->full_name }}</div>
                                        <div class="text-sm text-gray-500">{{ $invitation->individual->code_cmas }}</div>
                                    </div>
                                </td>
