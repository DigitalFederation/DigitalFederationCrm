<x-layout>
    <div class="previous-layout-classes">
        ...
        <div class="mb-8 flex justify-between">
            ...
            <!-- Title -->
            <h1 class="page-first-title">{{ __('Edit Membership Plan') }}</h1>
                    ...
                    <div class="grow">
                        ...
                        <section class="p-6 space-y-6">
                            ...
                            <div
                                ...
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="committee">{{ __('Type') }} <span
                                            class="text-rose-500">*</span></label>
                                    <select name="committee_id" id="committee"
                                            class="form-select w-full {{ $errors->has('committee_id') ? 'border-rose-300' : '' }}"
                                            required>
                                        <option value="0"> CMAS</option>
                                        @foreach($committees as $committee)
                                            <option value="{{ $committee->id }}"
                                                    @if(old('committee_id', $plan->committee_id) === $committee->id) selected @endif>
                                ...
                                <div class="w-full">
                                    ...
                                    <input id="name"
                                           ...
                                           type="text" name="name" value="{{ old('name',$plan->name) }}" required />
                                    @if($errors->has('name'))
                                        <div class="text-xs mt-1 text-rose-500 h-2">
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <input id="friendly_name"
                                           ...
                                           type="text" name="friendly_name"
                                           value="{{ old('friendly_name', $plan->friendly_name) }}"
                                    />
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <input id="interval"
                                           ...
                                           value="{{ old('interval',$plan->interval) }}" />
                                ...
                                <div>
                                    ...
                                    <select name="interval_unit" id="interval_unit"
                                        ...
                                        @foreach($interval_unit as $key=>$type)
                                            <option
                                                value="{{ $key }}" {!! (collect(old('interval_unit',$plan->interval_unit))->contains($key)) ? 'selected="selected"' : '' !!} >{{ $type }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="sm:flex sm:items-top space-y-4 sm:space-y-0 sm:space-x-4 mt-5 ">
                                ...
                                <div>
                                    ...
                                    <livewire:input.select-multiple
                                        wire:model.live="licenses"
                                        :items="$licenses"
                                        inputId="licenses"
                                        inputName="licenses[]"
                                        :inputSelected="$plan->licenses->pluck('id')->toArray()" />
                                    <div
                            ...
                            <div class="flex flex-col px-6 py-5 border-t border-slate-200">
                                <div class="flex self-end">
                                    <a class="btn self-center bg-slate-500 text-white"
                                       href="{{ route(Request::segment(1).'.membership-plan.index') }}">{{ __('Cancel') }}</a>
                                    <button type="submit"
                                            class="btn bg-blue-500 hover:bg-blue-600 text-white ml-3 px-3 py-2 rounded">{{ __('Edit Record') }}
                                    </button>
                                </div>
                            </div>
                        </section>
