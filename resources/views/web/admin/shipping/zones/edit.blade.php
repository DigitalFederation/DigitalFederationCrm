<x-layout>
    <div class="previous-layout-classes">
        ...
        <div class="mb-8 flex justify-between">
            <h1 class="page-first-title">{{ __('Edit Shipping Zone') }}</h1>
        </div>
                    ...
                    <section class="mb-4 w-full">
                        ...
                        <div class="flex flex-wrap -mx-4 space-y-4 md:space-y-0">
                            ...
                            <div class="w-full px-4 md:w-1/2">
                                ...
                                <input id="name" class="form-input w-full" type="text" name="name" value="{{ old('name',$zone->name) }}" required />
                                @error('name')
                            ...
                            <!-- Countries Selection -->
                            <div class="w-full px-4 md:w-1/2">
                                <label class="block text-sm font-medium mb-1" for="sub_zones">{{ __('Shipping Destinations') }} <span class="text-rose-500">*</span></label>
                                ...
                                <livewire:input.select-multiple
                                    ...
                                    :inputSelected="$zone->subZones->pluck('id')->toArray() ?? []"
                                    :multiple="true"/>
