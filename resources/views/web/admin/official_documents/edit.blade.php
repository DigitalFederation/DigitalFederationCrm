                        ...
                        <div class="bg-gray-50 px-4 py-5 sm:p-6 rounded-md">
                            @if($documentType === 'entity' && $document->owner)
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-gray-900">{{ $document->owner->code_cmas }}</p>
                                    </div>
                                </div>
                            @elseif($documentType === 'individual' && $document->individual)
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        <span class="text-sm font-medium text-gray-500">{{ __('official_documents.cmas_code') }}:</span>
                                        <p class="mt-1 text-sm text-gray-900">{{ $document->individual->code_cmas }}</p>
                                    </div>
                                </div>
                            @elseif($documentType === 'federation' && $document->federation)
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900">{{ $document->federation->code_cmas }} - {{ $document->federation->name }}</p>
                                </div>
                            @endif
                        </div>
                    </div>
