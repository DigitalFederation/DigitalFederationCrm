    ...
    <x-ui.tabs :tabs="$tabsConfig" defaultTab="overview">
        ...
        <x-slot name="tab_overview">
            <div class="space-y-6">
                ...
                @if ($showUserAccount && $isCmasContext && $entity->users->first())
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('main.CMAS Code') }}</th>
                                </tr>
                            </thead>
