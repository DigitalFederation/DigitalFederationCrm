                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <div class="inline-flex items-center gap-2 px-3 py-2 bg-gray-50 rounded-lg border border-gray-100">
                            <span class="text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('main.CMAS Code') }}</span>
                            <span class="text-sm font-bold text-gray-900">{{ $entity->code_cmas }}</span>
                        </div>
                    </div>
                </div>
            </div>
