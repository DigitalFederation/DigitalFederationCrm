            ...
            <section class="my-8">
                ...
                <div class="sm:flex sm:items-start space-y-4 sm:space-y-0 sm:space-x-4 mt-4">
                    ...
                    <div class="sm:w-1/2">
                        ...
                        @else
                            {{-- CMAS Admin flow or Edit with permission: show zone selector --}}
                ...
                {{-- CMAS Portal Access (for CMAS and Admin namespaces) --}}
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-4">
                        <label class="inline-flex items-center">
                            <input type="checkbox"
                                   name="has_cmas_portal"
                                   id="has_cmas_portal"
                                   value="1"
                                   class="form-checkbox"
                                   {{ old('has_cmas_portal', $entity->has_cmas_portal ?? false) ? 'checked' : '' }}>
                            <span class="ml-2">{{ __('entity.has_cmas_portal_account') }}</span>
                        </label>
