...
@php
    ...
    $divingPages = ['diving-service-providers', 'diving-professionals', 'diving-locations'];
@endphp
                ...
                <nav class="flex items-center space-x-6">
                    ...
                    <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                        ...
                        <div x-show="open"
                            ...
                            <a href="{{ route('public.diving-locations') }}"
                                class="block px-4 py-2 text-sm text-slate-700 hover:bg-blue-50 hover:text-blue-600 whitespace-nowrap {{ $currentPage === 'diving-locations' ? 'bg-blue-50 text-blue-600' : '' }}">
                                {{ __('welcome.diving_locations_map') }}
                            </a>
                        </div>
                    </div>
                </nav>
        ...
        <div class="px-4 py-4 space-y-1">
            ...
            <div x-data="{ mobileSubmenu: {{ in_array($currentPage, $divingPages) ? 'true' : 'false' }} }">
                ...
                <div x-show="mobileSubmenu" x-collapse class="pl-4 mt-1 space-y-1">
                    ...
                    <a href="{{ route('public.diving-locations') }}"
                        class="block px-3 py-2 rounded-lg text-slate-600 hover:bg-slate-100 text-sm {{ $currentPage === 'diving-locations' ? 'bg-blue-50 text-blue-600' : '' }}">
                        {{ __('welcome.diving_locations_map') }}
                    </a>
                </div>
            </div>
