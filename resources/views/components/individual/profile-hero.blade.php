        ...
        <div class="flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-8 items-start md:items-center">
            ...
            <div class="flex-1">
                ...
                <div class="grid grid-cols-2 sm:flex sm:flex-wrap gap-3 sm:gap-4 md:gap-6 mt-3 sm:mt-4">
                    <!-- Nº Filiado -->
                    <div class="min-w-0">
                        <p class="text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('main.CMAS Code') }}</p>
                        <p class="text-sm sm:text-base md:text-lg font-bold text-primary truncate">{{ $individual->code_cmas }}</p>
                    </div>
