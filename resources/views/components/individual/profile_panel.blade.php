        ...
        <div class="flex flex-col md:flex-row gap-5">
            ...
            <div class="flex flex-col items-center space-y-3">
                ...
                <div class="mt-2 p-2 bg-white rounded-lg border border-secondary shadow-sm">
                    <img src="{{ $individual->qrcode_path }}" alt="{{ $individual->code_cmas }}"
            ...
            <div class="flex-grow">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="bg-primary/5 p-3 rounded-lg">
                        <div class="flex justify-between items-center">
                            <p class="text-sm font-medium text-gray-500">{{ __('main.CMAS Code') }}</p>
                            <p class="text-lg font-bold text-primary">{{ $individual->code_cmas }}</p>
                        </div>
                    </div>
