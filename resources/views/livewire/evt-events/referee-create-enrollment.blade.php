                    ...
                    <div class="flex items-center justify-between p-3 cursor-pointer" @click="showSelected = !showSelected">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm font-medium text-blue-800">
                                {{ __('events.referees_selected', ['count' => count($selectedIndividuals)]) }}
                            </span>
    ...
    <div x-show="currentStep === 2">
        <div class="space-y-6">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <h2 class="text-lg font-semibold text-gray-900">{{ __('events.step_2_referee_info') }}</h2>
                <p class="mt-1 text-sm text-gray-500">
                    {{ __('events.complete_info_for_selected_referees', ['count' => count($selectedIndividuals)]) }}
                </p>
            </div>
            ...
            <div class="flex justify-end gap-x-3">
                ...
                <x-filament::button
                    ...
                    {{ __('events.complete_referee_registration') }}
                </x-filament::button>
            </div>
        </div>
    </div>
