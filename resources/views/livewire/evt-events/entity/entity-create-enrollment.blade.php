        ...
        <div class="flex items-start">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-blue-700">
                    <p>You have {{ $preRegisteredCount }} athletes pre-registered for this event on {{ $preRegistrationDate?->format('M d, Y') }}</p>
                    <a href="{{ route('entity.evt-events.events.enrollments.pre-register', $event) }}"
                    ...
                    <div class="mt-2 space-y-3 text-sm text-gray-600">
                        @if($enrollmentType === \App\Enums\EvtEventEnrollmentRoleEnum::ATHLETE->value)
                            <div class="flex items-start space-x-2">
                                ...
                                <p>This page allows you to assign disciplines to your pre-registered athletes. Only athletes who completed pre-registration are shown here.</p>
                            </div>
                            <div class="flex items-start space-x-2">
                                <span class="font-medium">2.</span>
                                <p>Use the discipline filters above to find specific disciplines. <span class="text-amber-600 font-medium">Note: These filters affect disciplines only, not the athletes list.</span></p>
                            </div>
                            <div class="flex items-start space-x-2">
                                <span class="font-medium">3.</span>
                                <p>Select athletes from the table and assign them to the filtered discipline. You can repeat this process for different disciplines.</p>
                            </div>
                        @else
    ...
    <div x-show="currentStep === 2">
        ...
        <div class="space-y-6">
                    ...
                    <div class="border-t border-gray-200 px-4 py-3 bg-gray-50">
                        <div class="flex flex-wrap items-center gap-4">
                            ...
                            @if($selectedDisciplineModel->athlete_limit)
                                <span class="inline-flex items-center rounded-md bg-yellow-50 px-2 py-1 text-xs font-medium text-yellow-800">
                            ...
                            <div class="flex flex-wrap items-center gap-4">
                                ...
                                <div class="flex items-center gap-x-3 min-w-[250px]">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">CMAS: {{ $selected['code_cmas'] }}</p>
                                    </div>
                                </div>
                                    ...
                                    @if ($enrollmentType === \App\Enums\EvtEventEnrollmentRoleEnum::ATHLETE->value && !empty($disciplineAttributes))
                                        @foreach ($disciplineAttributes as $attributeKey => $attributeData)
                                            <div class="justify-end content-end">
                                                <label for="attribute_{{ $attributeData['attribute_data']['id'] }}_{{ $selected['id'] }}"
            ...
            <div class="flex justify-end gap-x-3">
                ...
                >
                    Submit Registration to Waiting List
                </x-filament::button>
            </div>
        </div>
    </div>
