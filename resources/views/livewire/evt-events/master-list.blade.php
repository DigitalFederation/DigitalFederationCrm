            ...
            document.addEventListener("livewire:init", function() {
                var table = new Tabulator("#events-table", {
                    ...
                    columns: [
                        ...
                        { title: "Organizer", field: "organizer.organizable.code_cmas", editor: "input" },
                        {
                        ...
                        {
                            title: "{{ __('certifications.cmas_code') }}",
                            field: "competition.technicalDelegates.0.code_cmas_delegate_federation",
                            editor: "input"
                        },
                        {
