    ...
    <form wire:submit.prevent="save" class="mt-4">
        ...
        <div class="flex flex-col md:flex-row justify-between gap-x-2">
            ...
            <div class="w-full md:w-1/3">
                <label for="codeCmasDelegateFederation" class="block text-sm font-medium mb-1">CMAS Delegate Code <span
                        class="text-rose-500">*</span></label>
                <input type="text" wire:model="codeCmasDelegateFederation" id="codeCmasDelegateFederation"
                       class="form-input w-full" required>
                @error('codeCmasDelegateFederation') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
            </div>
