            ...
            <div class="bg-white border border-blue-100 rounded-xl shadow-sm p-6 flex flex-col items-start">
                ...
                @if($selectedSchool)
                    <div>
                        ...
                        @if($selectedSchool->code_cmas)
                            <div class="text-xs text-gray-500 mt-1">CMAS: {{ $selectedSchool->code_cmas }}</div>
                        @endif
            ...
            <div class="bg-white border border-green-100 rounded-xl shadow-sm p-6 flex flex-col items-start">
                ...
                @if($selectedDirector)
                    <div>
                        ...
                        @if($selectedDirector->code_cmas)
                            <div class="text-xs text-gray-500 mt-1">CMAS: {{ $selectedDirector->code_cmas }}</div>
                        @endif
                        ...
                        @foreach($selectedAssistants as $assistant)
                            <li class="flex items-center justify-between group">
                                <div>
                                    ...
                                    @if($assistant->code_cmas)
                                        <div class="text-xs text-gray-500">CMAS: {{ $assistant->code_cmas }}</div>
                                    @endif
                                    @if($assistant->email)
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    @if($student->code_cmas)
                                                        <div class="text-xs text-gray-500">CMAS: {{ $student->code_cmas }}</div>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
