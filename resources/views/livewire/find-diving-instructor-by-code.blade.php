<div>
    ...
    <section>
        ...
        <div class="mt-4">
            <label class="block text-sm font-medium mb-1" for="find_instructor_cmas_code">{{ __('main.CMAS Code') }}</label>
            <div class="flex items-end">
                <input wire:model.live="instructorCode" type="text" class="w-full form-input rounded-r-none"
                    name="individual" id="find_instructor_cmas_code" {{ $entityId === null ? 'disabled' : '' }}>
                <x-entity-instructor-selector :entity-id="$entityId" inputId="find_instructor_cmas_code"
