                            ...
                            <table class="w-full text-sm text-left text-gray-500 mt-4">
                                <thead class="text-xs uppercase text-slate-500 bg-slate-200 rounded-sm">
                                    <tr>
                                        ...
                                        <th class="p-2">
                                            <div class="font-semibold text-center">{{ __('main.CMAS Code') }}</div>
                                        </th>
                                        <th class="p-2">
                                ...
                                <tbody>
                                    <tr class="border-b border-gray-300">
                                        ...
                                        <td class="py-1 text-center">{{ $instructor['code_cmas'] }}</td>
                    ...
                    @if (!empty($assistantInstructor))
                        ...
                        @foreach ($assistantInstructor as $assistant)
                            <div class="flex items-center mt-4">
                                ...
                                <div><small>( {{ $assistant['code_cmas'] }})</small></div>
                            </div>
