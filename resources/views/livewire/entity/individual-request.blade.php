<div class="mt-4">
    ...
    <form wire:submit.prevent="submit" class="mt-4">
        ...
        <div class="flex flex-col w-full sm:w-1/2">
            <label for="code_cmas" class="block text-sm font-medium mb-1">
                {{ __('main.personal_id') }}
            </label>
            <input wire:model="code_cmas" type="text" name="code_cmas" id="code_cmas"
                   class="form-input w-full @error('code_cmas') border-rose-300 @enderror"
