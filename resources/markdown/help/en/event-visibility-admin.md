...
*   **Required Athlete Licenses:** Select specific CMAS Licenses that athletes **must** possess to be enrolled.
*   **Required Coach Certifications:** Select specific CMAS Certifications that coaches **must** possess.
*   **Required Referee Certifications:** Select specific CMAS Certifications that referees **must** possess.
