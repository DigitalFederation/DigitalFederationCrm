...
This file is the neutral contributor and coding-agent guide for Digital Federation CRM. Follow it when making changes in this repository.

## Project Overview

Digital Federation CRM is a Laravel 11 and Vite application for federation operations: members, entities, licenses, certifications, events, documents, payments, and public directories.
