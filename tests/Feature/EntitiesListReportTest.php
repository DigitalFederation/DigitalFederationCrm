...
test('has_cmas_portal renders as yes or no', function () {
    $entityWithPortal = Entity::factory()->create(['has_cmas_portal' => true]);
    $entityWithoutPortal = Entity::factory()->create(['has_cmas_portal' => false]);
