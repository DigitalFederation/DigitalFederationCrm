...
use App\Http\Controllers\Federation\DivingLocationController as FederationDivingLocationController;
...
Route::group(['prefix' => 'federation', 'middleware' => ['user_group:FEDERATION']], function () {
    ...
    Route::controller(FederationDivingLocationController::class)->group(function () {
        Route::get('/diving-location', 'index')->name('federation.diving-location.index');
        Route::get('/diving-location/create', 'create')->name('federation.diving-location.create');
        Route::post('/diving-location', 'store')->name('federation.diving-location.store');
        Route::get('/diving-location/{id}', 'show')->name('federation.diving-location.show');
        Route::get('/diving-location/{id}/edit', 'edit')->name('federation.diving-location.edit');
        Route::put('/diving-location/{id}', 'update')->name('federation.diving-location.update');
        Route::delete('/diving-location/{id}', 'destroy')->name('federation.diving-location.delete');
    });

    // Diving Log
    Route::name('federation.')->group(function () {
        Route::resource('diving-log', \App\Http\Controllers\Federation\DivingLogController::class)->only(['index', 'show']);
        Route::resource('diving-log-validation', \App\Http\Controllers\Federation\DivingLogValidationController::class)->only(['update']);
    });
    ...
    // Insurance Documents (using shared controller like CMAS)
