...
use App\Http\Controllers\Entity\CmasDivingInstructorController as EntityCmasDivingInstructorController;
...
Route::group(['prefix' => 'entity', 'middleware' => ['user_group:ENTITY']], function () {
    ...
    Route::controller(EntityLicensesAttributedController::class)->group(function () {
        ...
        // Route::get('/license-attributed/create/{type}', 'create')->name('entity.license-attributed.create');
        // Route::post('/license-attributed', 'store')->name('entity.license-attributed.store');
    });
    ...
    Route::controller(EntitySeparatedLicenseAttributedController::class)->group(function () {
        ...
        Route::get('/cmas-diving-licenses-attributed', 'divingCmasEntity')->name('entity.cmas-diving-licenses-attributed.index');
        ...
        Route::get('/cmas-diving-member-licenses-attributed', 'divingCmasMembers')->name('entity.cmas-diving-member-licenses-attributed.index');
    ...
    Route::controller(EntityLicensePurchaseController::class)->group(function () {
        ...
        Route::get('/cmas-diving-license-purchase', 'divingCmasEntity')->name('entity.cmas-diving-license-purchase.index');
        ...
        Route::get('/cmas-diving-member-license-purchase', 'divingCmasMembers')->name('entity.cmas-diving-member-license-purchase.index');
    ...
    // International License Routes - CMAS
    ...
    Route::controller(EntityCmasDivingInstructorController::class)->middleware('check_entity_can_invite:diving')->group(function () {
        Route::get('cmas-diving-instructors/', 'index')->name('entity.cmas-diving-instructor.index');
        Route::delete('cmas-diving-instructors/cancel-invitation/{invitation}', 'cancelInvitation')->name('entity.cmas-diving-instructor.cancel_invitation');
        Route::delete('cmas-diving-instructors/remove/{id}', 'remove')->name('entity.cmas-diving-instructor.remove');
    });
