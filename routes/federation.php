...
Route::group(['prefix' => 'federation', 'middleware' => ['user_group:FEDERATION']], function () {
    ...
    Route::controller(FederationSeparatedLicenseAttributedController::class)->group(function () {
        ...
        Route::get('/international-diving-entity-licenses-attributed', 'divingInternationalEntity')
            ->name('federation.international-diving-entity-licenses-attributed.index');
        Route::get('/international-diving-individual-licenses-attributed', 'divingInternationalIndividual')
            ->name('federation.international-diving-individual-licenses-attributed.index');
