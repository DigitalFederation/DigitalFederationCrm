...
use App\Http\Controllers\Admin\DivingCourseController as AdminDivingCourseController;
/* ------------------------------------------------------------------------
 |  Controller imports – kept together for easy scanning
 |  (⌘/Ctrl-F on the filename to jump straight here)
 * --------------------------------------------------------------------- */
use App\Http\Controllers\Admin\DivingLocationController as AdminDivingLocationController;
...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::middleware('permission:access licenses')->group(function () {
            ...
            Route::controller(AdminSeparatedLicenseAttributedController::class)->group(function () {
                ...
                Route::get('/international-diving-entity-licenses-attributed', 'divingInternationalEntity')
                    ->name('international-diving-entity-licenses-attributed.index');
                Route::get('/international-diving-individual-licenses-attributed', 'divingInternationalIndividual')
                    ->name('international-diving-individual-licenses-attributed.index');
        ...
        Route::middleware('permission:access diving location')->group(function () {
            Route::resource('diving-location', AdminDivingLocationController::class)
                ->names('diving-location');
        });
        Route::resource('diving-course', AdminDivingCourseController::class)
            ->names('diving-course')
        ...
        Route::middleware('permission:access products')
            ->controller(AdminProductsController::class)
            ->prefix('products')
            ->name('products.')
            ->group(function () {
                Route::get('/', 'index')->name('index');
