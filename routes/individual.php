...
use App\Http\Controllers\Individual\DivingBuddiesController;
...
use App\Http\Controllers\Individual\DivingLocationController as IndividualDivingLocationController;
use App\Http\Controllers\Individual\DivingLogController;
use App\Http\Controllers\Individual\DivingLogValidationController;
...
Route::group(['prefix' => 'individual', 'middleware' => ['user_group:INDIVIDUAL']], function () {
    ...
    Route::controller(IndividualLicensePurchaseController::class)->group(function () {
        ...
        Route::get('/sport-license-purchase', 'sport')->name('individual.sport-license-purchase.index');
        Route::get('/national-diving-license-purchase', 'nationalDiving')->name('individual.national-diving-license-purchase.index');
        Route::get('/international-diving-license-purchase', 'divingInternational')->name('individual.international-diving-license-purchase.index');
        Route::get('/scientific-license-purchase', 'scientific')->name('individual.scientific-license-purchase.index');
    });

    // Separated licenses attributed routes by committee
    Route::controller(IndividualSeparatedLicenseAttributedController::class)->group(function () {
        Route::get('/sport-licenses-attributed', 'sport')->name('individual.sport-licenses-attributed.index');
        Route::get('/national-diving-licenses-attributed', 'nationalDiving')->name('individual.national-diving-licenses-attributed.index');
        Route::get('/international-diving-licenses-attributed', 'divingInternational')->name('individual.international-diving-licenses-attributed.index');
        Route::get('/scientific-licenses-attributed', 'scientific')->name('individual.scientific-licenses-attributed.index');
    });
    ...
    Route::controller(DivingLogController::class)->group(function () {
        Route::get('/diving-log', 'index')->name('individual.diving-log.index');
        Route::get('/diving-log/{divingLog}/edit', 'edit')->name('individual.diving-log.edit');
        Route::get('/diving-log/create', 'create')->name('individual.diving-log.create');
        Route::get('/diving-log/{id}', 'show')->name('individual.diving-log.show');
        Route::delete('/diving-log/{divingLog}', 'destroy')->name('individual.diving-log.delete');
    });

    // DivingBuddy Controller
    Route::group([], function () {
        Route::get('/diving-buddy', [DivingBuddiesController::class, 'index'])->name('individual.diving-buddy.index');
        Route::post('/diving-buddy', [DivingBuddiesController::class, 'store'])->name('individual.diving-buddy.store');
        Route::get('/diving-buddy/{divingBuddy}/edit', [DivingBuddiesController::class, 'edit'])->name('individual.diving-buddy.edit');
        Route::put('/diving-buddy/{divingBuddy}', [DivingBuddiesController::class, 'update'])->name('individual.diving-buddy.update');
        Route::delete('/diving-buddy/{divingBuddy}', [DivingBuddiesController::class, 'destroy'])->name('individual.diving-buddy.destroy');
    });

    Route::controller(DivingLogValidationController::class)->group(function () {
        Route::get('/diving-log-validation', 'index')->name('individual.diving-log-validation.index');
        Route::get('/diving-log-validation/create/{id}', 'create')->name('individual.diving-log-validation.create');
        Route::post('/diving-log-validation/{id}', 'store')->name('individual.diving-log-validation.store');
        Route::get('/diving-log-validation/{id}', 'show')->name('individual.diving-log-validation.show');
        Route::put('/diving-log-validation/{id}', 'update')->name('individual.diving-log-validation.update');
    });

    Route::controller(IndividualDivingLocationController::class)->group(function () {
        Route::get('/diving-location', 'index')->name('individual.diving-location.index');
        Route::get('/diving-location/create', 'create')->name('individual.diving-location.create');
        Route::post('/diving-location', 'store')->name('individual.diving-location.store');
        Route::get('/diving-location/{id}', 'show')->name('individual.diving-location.show');
        Route::get('/diving-location/{id}/edit', 'edit')->name('individual.diving-location.edit');
        Route::put('/diving-location/{id}', 'update')->name('individual.diving-location.update');
        Route::delete('/diving-location/{id}', 'destroy')->name('individual.diving-location.delete');
    });
